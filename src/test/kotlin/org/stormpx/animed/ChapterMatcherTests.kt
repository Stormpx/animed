...
class ChapterMatcherTests {
    ...
    fun testMatch(){
        val testcases = arrayOf(
            ...
            TestCase("[酷漫404][夏日重现][#chapter#][1080P][WebRip][简日双语][AVC AAC][MP4][字幕组招人内详]",
                arrayOf(
            ...
            TestCase("【幻月压制】【22年日剧】【欢迎光临自助洗衣店】【#chapter#】【1080P】【中文字幕】",
                arrayOf(
                    TestResult("【幻月压制】【22年日剧】【欢迎光临自助洗衣店】【04】【1080P】【中文字幕】" ,true,4.0),
                    TestResult("【幻月压制】【日剧】【欢迎光临自助洗衣店】【04】【1080P】【中文】" ,false,-1.0),
                )
            ),
            TestCase("【喵萌奶茶屋】★07月新番★[异世界舅舅/Isekai Ojisan][#chapter#][1080p][简日双语][招募翻译]",
                arrayOf(
            ...
            TestCase("[织梦字幕组]Summer Time Rendering 夏日重现[#chapter#]#mono#",
                arrayOf(
        ...
        testcases.forEach {
            val matcher = ChapterMatcher(it.pattern)
